...
function criarForm(conta: FinanceiroPlanoConta | null): FormState {
...
function FormularioPlanoConta({ conta, onFechar, onSalvo }: Omit<Props, 'aberto'>) {
